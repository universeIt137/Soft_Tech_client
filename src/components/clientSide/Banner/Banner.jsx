    ...
    return (
        <div data-aos="zoom-out-up" className='lg:flex  mb-12 items-center'>
            <div className='flex-1 md:mt-10 mx-6 xl:mx-32  text-center lg:text-start'>
                ...
                >
                    Universe SoftTech is a Bangladesh based Enterprise IT Solutions Company in Bangladesh. Universe SoftTech maintains a high-quality infrastructure worldwide. Main objective is to give the best possible service to customers.
                </p>
