        ...
        <div className="py-16">
            <div className="container mx-auto flex flex-col md:flex-col lg:flex-row justify-between items-center md:px-8">
                ...
                <div className="flex-1  lg:pb-20 md:pb-2 pb-5 md:leading-10">
                    ...
                    <h1 className="my-3 leading-relaxed lg:text-4xl text-center lg:text-start md:text-start text-text_blue text-2xl  font-bold -tracking-[0.044rem]">Get 100% Secure <span className="text-text_primari">Cloud <br className="hidden  lg:block" />Based <br className="block md:block lg:hidden" /> Custom</span> Software <br className="hidden lg:block"/> Solution</h1>
