            ...
            <div className="container mx-auto flex flex-col md:flex-col lg:flex-row justify-between items-center md:px-8">
                ...
                <div className="flex-1  lg:pb-20 md:pb-2 pb-5 md:leading-10">
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-row gap-5 py-5 px-10 md:px-0 lg:px-0">
                        <button className="bg-[#2980B9] text-white text-xl rounded-[50px] py-2.5 px-5 cursor-pointer lg:w-[200px] md:w-[200px] border-none text-center inline-block hover:-translate-y-1 hover:translate-x-1 hover:shadow-xl hover:transform hover:duration-500  hover:ease-in-out w-full">Get a Demo</button>
                        <button className="border border-[#2980b9] text-[#2980b9] rounded-[50px] py-2.5 px-5 cursor-pointer lg:w-[200px] md:w-[200px] text-center inline-block hover:-translate-y-1 hover:translate-x-1 hover:shadow-lg hover:transform hover:duration-500 hover:ease-in-out w-full">Start a Project</button>
                    </div>
                </div>
                {/* img */}
