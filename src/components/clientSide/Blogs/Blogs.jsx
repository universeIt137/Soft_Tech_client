    ...
    return (
        <div className='w-11/12 mx-auto flex flex-col-reverse lg:flex lg:flex-row my-20 gap-10'>
            <div className="lg:w-3/5 text-justify mr-10 mt-5">
                ...
                <p className="text-xl mb-6">Leadership and senior consultants have decades of combined experience, allowing Alpha Net to bring a complete understanding of a wide range of business environments to every clients.</p>   
            </div>
