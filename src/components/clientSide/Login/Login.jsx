...
//   const from = location.state ? location.state.prev : "/";
...
//   };
  ...
  return (
    <div className="bg-[#AED6F1] py-5">
      <>
       
        <div className="lg:w-[60vw] w-[90vw] bg-universe_secendary text-white mx-auto my-10  p-4 rounded-md shadow sm:p-8  ">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="space-y-2 relative">
                ...
                <span
                  ...
                  className="absolute text-gray-500   top-[40%] text-xl right-3 "
                >
                  {" "}
            ...
            >
               {
                 isLoader ? <span className="flex items-center justify-center gap-3"><FaSpinner className="animate-spin" />Processing....</span> : "Login"
                 }
            </button>
          </form>
        </div>
