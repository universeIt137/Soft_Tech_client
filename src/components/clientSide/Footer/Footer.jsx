        ...
        <div className='container mx-auto py-10 px-5 md:px-10 text-white'>
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-10'>
                ...
                <div className="lg:col-span-4 flex flex-col items-center lg:items-start">
                    <img className='w-[150px] md:w-[200px] border' src={subLogo} alt="Nimusoft Logo" />
                    <div className="mt-5 text-center lg:text-left">
                        <p className="flex items-center justify-center lg:justify-start gap-2"><FaLocationDot /> 5/A, Ga-130/B, Progoti Sharani, Middle</p>
                        <p className="text-center lg:text-left">Badda, Gulshan, Badda, Dhaka-1212.</p>
                        
                    </div>
                </div>
    
                {/* Links Section */}
                <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-5 lg:gap-10">
                    {/* 2nd */}
                    <div>
