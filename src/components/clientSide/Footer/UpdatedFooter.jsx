                ...
                <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 text-white">
                            ...
                            <li><Link to='' className="hover:text-gray-800">Case Studies</Link></li>
                            <li><Link to='/about-us' className="hover:text-gray-800">About Us</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Careers</Link></li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 text-white">
                            <li><Link to='' className="hover:text-gray-800">SoftTech HRM</Link></li>
                            <li><Link to='' className="hover:text-gray-800">SoftTech Attendance</Link></li>
                            <li><Link to='' className="hover:text-gray-800">SoftTech CRM</Link></li>
                            <li><Link to='' className="hover:text-gray-800">SoftTech POS</Link></li>
                            <li><Link to='' className="hover:text-gray-800">SoftTech Inventory</Link></li>
                        </nav>
                    </div>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 text-white">
                            <li><Link to='' className="hover:text-gray-800">ERP Solution</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Mobile Application</Link></li>
                            <li><Link to='' className="hover:text-gray-800">E-Commerce</Link></li>
                            <li><Link to='' className="hover:text-gray-800">IoT & VR</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Data Analytics</Link></li>
                        </nav>
                    </div>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 text-white">
                            <li><Link to='' className="hover:text-gray-800">Real Estate</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Mobile Application</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Education</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Home Automation</Link></li>
                            <li><Link to='' className="hover:text-gray-800">Robotics & AI</Link></li>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-universe_secondary">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row justify-between">
                    <p className="text-gray-500 text-sm text-center sm:text-left">
                        <span className='text-white'>© 2024 SoftTech Technologies Ltd.</span> 
